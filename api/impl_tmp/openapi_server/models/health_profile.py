...
class HealthProfile(Model):
    ...
    def __init__(self, health_profile_id=None, client_id=None, name=None, code=None, start_date=None, end_date=None, diagnosing_healthcare_provider_id=None, is_activity_impediment=None, is_risk_and_safety_issue=None, is_allergy=None, is_health_condition=None):  # noqa: E501
        ...
        :type client_id: str
        :param name: The name of this HealthProfile.  # noqa: E501
        :type name: str
        :param code: The code of this HealthProfile.  # noqa: E501
        :type code: str
    ...
    @property
    def name(self):
        """Gets the name of this HealthProfile.


        :return: The name of this HealthProfile.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HealthProfile.


        :param name: The name of this HealthProfile.
        :type name: str
        """
    ...
    @property
    def code(self):
        """Gets the code of this HealthProfile.


        :return: The code of this HealthProfile.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this HealthProfile.


        :param code: The code of this HealthProfile.
        :type code: str
        """
